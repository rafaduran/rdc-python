...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        resize_action = self.createAction("&Resize the image", 
                self.resize_image, "Alt+R", "editresize", "Resize the image")
        ...
        self.addActions(editMenu, (editInvertAction,
                editSwapRedAndBlueAction, editZoomAction, resize_action))
