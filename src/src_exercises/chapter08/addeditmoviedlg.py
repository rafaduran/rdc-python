...
class AddEditMovieDlg(QDialog,
    ...
    def __init__(self, movies, movie=None, parent=None):
        ...
        if movie is not None:
            ...
            if(self.movie.location is not None):
                self.location_edit.setText(self.movie.location)
...
if __name__ == "__main__":
    ...
    mov = moviedata.MovieContainer()
    form = AddEditMovieDlg(mov)
    form.show()
    app.exec_()
    print([movie.location for movie in mov])
