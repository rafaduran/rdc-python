...
class BuildingServicesClient(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        buttonLayout.addWidget(self.books_date_button)
        buttonLayout.addWidget(self.books_room_button)
        ...
        self.connect(self.books_date_button, SIGNAL("clicked()"),
            self.books_date)
        self.connect(self.books_room_button, SIGNAL("clicked()"),
            self.books_room)
